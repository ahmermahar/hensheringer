$(function () {
  ...
  var shuffleme = (function( $ ) {
    'use strict';
        ...
        $filterOptions = $('.FRAGEN-sorting li'),  //locate the filter categories
    ...
    setupFilters = function() {
      ...
      $btns.on('click', function(e) {
        ...
        if ( !isActive ) {
          $('.FRAGEN-sorting li a').removeClass('active');
        }
    ...
    listen = function() {
      ...
      // Because this method doesn't seem to be richtig.
      setTimeout(function() {
        debouncedLayout();
      }, 500);
    };      
  ...
  this.FetchAll = function() {
    ...
    if (this.comments.length > 0) {
      for (i = 0; i < this.comments.length; i++) {
        // data += '<tr>';
        // data += '<td>'+(i+1)+". " + this.comments[i] + '</td>';
        ...
        data += '<div class="message-blue">';
        data += '<p class="message-content">'+ this.comments[i] +!'</p>';
        data += '<div class="message-timestamp-left">SMS 13:37</div>';
        data += '</div>';
      }
    }
